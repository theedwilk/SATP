  ...
  <footer className="mt-8 py-4 border-t border-gray-200 bg-gray-50">
    <div className="max-w-xl mx-auto text-center px-4">
      <a
        ...
        className="inline-flex items-center space-x-2 px-3 py-1.5 bg-gray-800 text-white rounded-md hover:bg-gray-700 transition-colors duration-200 text-sm"
      >
...
{esfera && poder && orgao && (
  ...
  // Tela de resultados (mantive o resto do código igual)
  return (
    <div className="min-h-screen flex flex-col">
    ...
    <div className="flex flex-col lg:flex-row items-start gap-6">
      <div className="lg:w-1/3">
        ...
        <div className="space-y-1 text-sm text-gray-600">
          <p><span className="font-semibold">Esfera:</span> {esfera}</p>
          <p><span className="font-semibold">Poder:</span> {poder}</p>
          <p><span className="font-semibold">Órgão:</span> {orgao}</p>
        </div>
      </div>
